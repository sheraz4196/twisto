...
export default function Home() {
  return <div className="flex h-screen items-center justify-center p-4 text-center md:p-6 lg:p-8 bg-primary-600 ">
    <div className='border-black border-x-2 h-screen grid place-items-center px-5'>
    <div className="sm:max-w-3xl lg:max-w-3xl">
      <div className='flex flex-col gap-4 lg:gap-8 text-zinc-700'>
        <p>Community awaits you</p>
        <h3 className='text-5xl font-semibold tracking-tight sm:px-10 md:px-24 lg:px-20 lg:text-6xl'>Activate Your Message Community</h3>
